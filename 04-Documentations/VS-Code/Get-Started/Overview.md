...
* **Build with AI agents.** Describe what you want in natural language, and an agent plans a solution, edits files across your project, runs commands, and fixes its own errors. Run agents in the [[Agents Window|Agents window]] for an agent-first workflow, or in the [[04-Documentations/VS-Code/Agents/Agents/Chat View|Chat view]] while you write code in the editor. Learn more about AI Agents in VS Code.
