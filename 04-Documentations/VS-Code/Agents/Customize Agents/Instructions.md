...
- A single Use a [[Instructions#Use a .github/copilot-instructions.md file|.github/copilot-instructions.md]] file
    - Automatically applies to all chat requests in the workspace
    - Stored within the workspace

- One or more [[Instructions#Use an AGENTS.md file|AGENTS.md]] files
...
- [[Instructions#Use a CLAUDE.md file|CLAUDE.md]] file
...
> [!Tip]
In a monorepo, enable `chat.useCustomizationsInParentRepositories` to discover instructions from the parent repository root. Learn more about parent repository discovery.
...
![Screenshot of the Agent Customizations editor, showing the Instructions tab and the dropdown to create a new instructions file.](https://code.visualstudio.com/assets/docs/agent-customization/customization/create-instructions-file.png)
...
## [Share custom instructions across teams](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_share-custom-instructions-across-teams)
...
## [Sync user instructions files across devices](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_sync-user-instructions-files-across-devices)
...
## [Specify custom instructions in settings](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_specify-custom-instructions-in-settings)
...
## [Instruction priority](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_instruction-priority)
...
## [Tips for writing effective instructions](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_tips-for-writing-effective-instructions)
...
## [Frequently asked questions](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_frequently-asked-questions)

### [Why is my instructions file not being applied?](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_why-is-my-instructions-file-not-being-applied)
...
### [How do I know where a custom instruction file comes from?](https://code.visualstudio.com/docs/agent-customization/custom-instructions#_how-do-i-know-where-a-custom-instruction-file-comes-from)
...
1. Select **Chat: Configure Instructions** from the Command Palette (Ctrl+Shift+P).
