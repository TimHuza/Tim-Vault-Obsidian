...
In this article, you learn about the Agents window and how to start and manage agent sessions across your projects. For chat mechanics that apply to both the Agents window and the [[04-Documentations/VS-Code/Agents/Agents/Chat View|Chat view]] — such as sending requests, adding context, and reviewing changes — see Use chat in VS Code.

> [!Tip]
> The Agents window (agent-first) and the [[04-Documentations/VS-Code/Agents/Agents/Chat View|Chat view]] (code-first) are the main surfaces for working with agents. They share the same sessions and settings, so you can move freely between them. For help choosing, see [[04-Documentations/VS-Code/Agents/Overview#Choose how you work with agents|Choose how you work with agents]].
